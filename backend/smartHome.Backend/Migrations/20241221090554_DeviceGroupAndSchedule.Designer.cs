...
namespace smartHome.Backend.Migrations
{
    ...
    [Migration("20241221090554_DeviceGroupAndSchedule")]
    partial class DeviceGroupAndSchedule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeviceGroupDevices", b =>
                {
                    ...
                    b.HasKey("DeviceGroupId", "DevicesId");

                    b.HasIndex("DevicesId");

                    b.ToTable("DeviceGroupDevices");
                });
            ...
            modelBuilder.Entity("SmartHome.backend.Models.DeviceGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartHome.backend.Models.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartHome.backend.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeviceGroupDevices", b =>
                {
                    b.HasOne("SmartHome.backend.Models.DeviceGroup", null)
                        .WithMany()
                        .HasForeignKey("DeviceGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartHome.backend.Models.Device", null)
                        .WithMany()
